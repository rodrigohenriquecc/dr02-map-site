...
╚══════════════════════════════════════════════════════════════════════*/
let db   = null;        // será Firestore ou null
let col  = null;        // referência à coleção "pontos"
let online = false;     // muda para true se Firebase conectar
...
try {
  ...
  console.warn('⚠️ Firestore não configurado ou domínio não autorizado.\n' +
...
/*══════════════════════════════════════════════════════════════════════╗
║  2. Mapa, camadas e estruturas globais                               ║
╚══════════════════════════════════════════════════════════════════════*/
...
/*══════════════════════════════════════════════════════════════════════╗
║  3. Carregamento sequencial de dados                                 ║
╚══════════════════════════════════════════════════════════════════════*/
(async () => {
  try {
    /* 3.1 meta-dados kmIni/kmFim */
    ...
    zoomGlobal();
    inicializarUI();               // só depois que tudo foi carregado
    if (online) carregarFirestore();
  } catch (e) {
    console.error(e);
    alert('Falha no carregamento inicial. Veja o console para detalhes.');
  }
})();
...
function addPonto(d) {
  ...
  m.options.meta = { Rodovia, KM, Obs, Cor: cor, Raio: raio, LAT: lat, LON: lon };
}

/*══════════════════════════════════════════════════════════════════════╗
║  6. Firestore salvar/carregar                                        ║
╚══════════════════════════════════════════════════════════════════════*/
...
async function salvarFirestore() {
  ...
  try {
    ...
    console.error(e);
    alert('Falha ao salvar. Confira domínio autorizado e regras Firestore.');
  }
}

/*══════════════════════════════════════════════════════════════════════╗
║  7. KML → GeoJSON simplificado                                       ║
╚══════════════════════════════════════════════════════════════════════*/
